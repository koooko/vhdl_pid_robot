...
module processor_mm_interconnect_0 (
		...
		output wire [1:0]  DIRECTION_s1_address,                           //                             DIRECTION_s1.address
		output wire        DIRECTION_s1_write,                             //                                         .write
		input  wire [31:0] DIRECTION_s1_readdata,                          //                                         .readdata
		output wire [31:0] DIRECTION_s1_writedata,                         //                                         .writedata
		output wire        DIRECTION_s1_chipselect,                        //                                         .chipselect
	...
	wire  [90:0] button_s1_agent_rf_source_data;                                                     // BUTTON_s1_agent:rf_source_data -> BUTTON_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] button_s1_agent_rsp_fifo_out_data;                                                  // BUTTON_s1_agent_rsp_fifo:out_data -> BUTTON_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> BUTTON_s1_agent:cp_data
	...
	wire  [31:0] direction_s1_agent_m0_readdata;                                                     // DIRECTION_s1_translator:uav_readdata -> DIRECTION_s1_agent:m0_readdata
	wire         direction_s1_agent_m0_waitrequest;                                                  // DIRECTION_s1_translator:uav_waitrequest -> DIRECTION_s1_agent:m0_waitrequest
	wire         direction_s1_agent_m0_debugaccess;                                                  // DIRECTION_s1_agent:m0_debugaccess -> DIRECTION_s1_translator:uav_debugaccess
	wire  [13:0] direction_s1_agent_m0_address;                                                      // DIRECTION_s1_agent:m0_address -> DIRECTION_s1_translator:uav_address
	wire   [3:0] direction_s1_agent_m0_byteenable;                                                   // DIRECTION_s1_agent:m0_byteenable -> DIRECTION_s1_translator:uav_byteenable
	wire         direction_s1_agent_m0_read;                                                         // DIRECTION_s1_agent:m0_read -> DIRECTION_s1_translator:uav_read
	wire         direction_s1_agent_m0_readdatavalid;                                                // DIRECTION_s1_translator:uav_readdatavalid -> DIRECTION_s1_agent:m0_readdatavalid
	wire         direction_s1_agent_m0_lock;                                                         // DIRECTION_s1_agent:m0_lock -> DIRECTION_s1_translator:uav_lock
	wire  [31:0] direction_s1_agent_m0_writedata;                                                    // DIRECTION_s1_agent:m0_writedata -> DIRECTION_s1_translator:uav_writedata
	wire         direction_s1_agent_m0_write;                                                        // DIRECTION_s1_agent:m0_write -> DIRECTION_s1_translator:uav_write
	wire   [2:0] direction_s1_agent_m0_burstcount;                                                   // DIRECTION_s1_agent:m0_burstcount -> DIRECTION_s1_translator:uav_burstcount
	wire         direction_s1_agent_rf_source_valid;                                                 // DIRECTION_s1_agent:rf_source_valid -> DIRECTION_s1_agent_rsp_fifo:in_valid
	wire  [90:0] direction_s1_agent_rf_source_data;                                                  // DIRECTION_s1_agent:rf_source_data -> DIRECTION_s1_agent_rsp_fifo:in_data
	wire         direction_s1_agent_rf_source_ready;                                                 // DIRECTION_s1_agent_rsp_fifo:in_ready -> DIRECTION_s1_agent:rf_source_ready
	wire         direction_s1_agent_rf_source_startofpacket;                                         // DIRECTION_s1_agent:rf_source_startofpacket -> DIRECTION_s1_agent_rsp_fifo:in_startofpacket
	wire         direction_s1_agent_rf_source_endofpacket;                                           // DIRECTION_s1_agent:rf_source_endofpacket -> DIRECTION_s1_agent_rsp_fifo:in_endofpacket
	wire         direction_s1_agent_rsp_fifo_out_valid;                                              // DIRECTION_s1_agent_rsp_fifo:out_valid -> DIRECTION_s1_agent:rf_sink_valid
	wire  [90:0] direction_s1_agent_rsp_fifo_out_data;                                               // DIRECTION_s1_agent_rsp_fifo:out_data -> DIRECTION_s1_agent:rf_sink_data
	wire         direction_s1_agent_rsp_fifo_out_ready;                                              // DIRECTION_s1_agent:rf_sink_ready -> DIRECTION_s1_agent_rsp_fifo:out_ready
	wire         direction_s1_agent_rsp_fifo_out_startofpacket;                                      // DIRECTION_s1_agent_rsp_fifo:out_startofpacket -> DIRECTION_s1_agent:rf_sink_startofpacket
	wire         direction_s1_agent_rsp_fifo_out_endofpacket;                                        // DIRECTION_s1_agent_rsp_fifo:out_endofpacket -> DIRECTION_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> DIRECTION_s1_agent:cp_valid
	wire  [89:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> DIRECTION_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // DIRECTION_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> DIRECTION_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> DIRECTION_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> DIRECTION_s1_agent:cp_endofpacket
	...
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> ENABLE_s1_agent:cp_channel
	...
	wire  [89:0] button_s1_agent_rp_data;                                                            // BUTTON_s1_agent:rp_data -> router_005:sink_data
	...
	wire         direction_s1_agent_rp_valid;                                                        // DIRECTION_s1_agent:rp_valid -> router_006:sink_valid
	wire  [89:0] direction_s1_agent_rp_data;                                                         // DIRECTION_s1_agent:rp_data -> router_006:sink_data
	wire         direction_s1_agent_rp_ready;                                                        // router_006:sink_ready -> DIRECTION_s1_agent:rp_ready
	wire         direction_s1_agent_rp_startofpacket;                                                // DIRECTION_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         direction_s1_agent_rp_endofpacket;                                                  // DIRECTION_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         direction_s1_agent_rdata_fifo_src_valid;                                            // DIRECTION_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] direction_s1_agent_rdata_fifo_src_data;                                             // DIRECTION_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         direction_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_004:in_0_ready -> DIRECTION_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> DIRECTION_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> DIRECTION_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // DIRECTION_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> DIRECTION_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) direction_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (direction_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (direction_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (direction_s1_agent_m0_read),                     //                         .read
		.uav_write              (direction_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (direction_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (direction_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (direction_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (direction_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (direction_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (direction_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (direction_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (DIRECTION_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (DIRECTION_s1_write),                             //                         .write
		.av_readdata            (DIRECTION_s1_readdata),                          //                         .readdata
		.av_writedata           (DIRECTION_s1_writedata),                         //                         .writedata
		.av_chipselect          (DIRECTION_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (direction_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (direction_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (direction_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (direction_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (direction_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (direction_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (direction_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (direction_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (direction_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (direction_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (direction_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (direction_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (direction_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (direction_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (direction_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (direction_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (direction_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (direction_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (direction_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (direction_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (direction_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (direction_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (direction_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (direction_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (direction_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (direction_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (direction_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (direction_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (direction_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) direction_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (direction_s1_agent_rf_source_data),              //        in.data
		.in_valid          (direction_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (direction_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (direction_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (direction_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (direction_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (direction_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (direction_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (direction_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (direction_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	processor_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (direction_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (direction_s1_agent_rp_valid),                    //          .valid
		.sink_data          (direction_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (direction_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (direction_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (direction_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (direction_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (direction_s1_agent_rdata_fifo_src_ready),        //         .ready
